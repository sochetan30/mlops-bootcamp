...
# Filling Numeircal columns with median
...
def mlflow_logging(model,X,y, name):
    ...
    with mlflow.start_run() as run:
        ...
        #Metrics
        (accuracy,f1, auc) = eval_metric(y.values,pred)

        #Logging best parameers for gridsearch
        ...
        # Log the artificats and model
        mlflow.log_artifact("plots/ROC_curve.png") #plots/ROC_curve.png
