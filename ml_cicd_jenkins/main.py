...
#CORS cross orgin middleware- when a frontend is running in browser has javascript codde that communicates with backend

# Steps : Frontend is in javaascript
# 

# Wildcards  '*' - allowall orgins


app=FastAPI(title="Loan prediction APP using API -CICD Jenkns",
...
@app.get("/")
def index():
    return {"Messgae":"Welcome to Loan Prediction App using API"}
